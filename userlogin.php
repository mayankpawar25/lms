...
<html lang="en">
    ...
    <head>
        ...
        <title>WC: School Management System</title>
        ...
        <style type="text/css">
            ...
            body{background: #dde4d1;}        

            .discover{margin-top: -90px;position: relative;z-index: -1; display: none;}

            .form-bottom {box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.35);}

            .gradient{margin-top: 40px;text-align: center;padding: 10px;background: rgb(72,72,72);

                      background: -moz-linear-gradient(to right, rgba(255, 255, 255, 0) 1%,rgba(197, 201, 187, 0.6) 44%, rgba(158, 176, 123, 0) 100%);

                      background-image: linear-gradient(to right, rgba(255, 255, 255, 0) 1%,rgba(197, 201, 187, 0.6) 44%, rgba(158, 176, 123, 0) 100%);
                      ...
                      background: -webkit-linear-gradient(to right, rgba(255, 255, 255, 0) 1%,rgba(197, 201, 187, 0.6) 44%, rgba(158, 176, 123, 0) 100%);

                      background: linear-gradient(to right, rgba(255, 255, 255, 0) 1%,rgba(197, 201, 187, 0.6) 44%, rgba(158, 176, 123, 0) 100%);
            ...
            <div class="inner-bg">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-12 form-box">
