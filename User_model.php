...
class User_model extends CI_Model {
    ...
    public function checkUserLogin($pid){
        return $this->db->where('id',$pid)->get('users')->row();
    }
    ...
    public function checkUserExit($uid)
    {
         return $this->db->where('member_id',$uid)->get('libarary_members')->row();
    }
