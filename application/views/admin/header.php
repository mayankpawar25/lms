<header class="main-header">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  ...
                  <a href="<?php echo base_url('admin/profile/profile_details');?>" class="btn btn-default btn-flat">Profile</a>
  ...
  <div class="modal fade" id="user_profile" style="display : none;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                  <button type="button" id="closebutton" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="form-btn" style="float: right; margin-right: 15px"><?php 
              echo anchor('admin/profile/edit_profile','<span style="font-size: 14px;"><i class="fa fa-pencil" aria-hidden="true" ></i> Edit Profile</span> ' ); 
            ?></div>
