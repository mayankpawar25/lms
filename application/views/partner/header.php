<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>/partner" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">CDS LMS</span>
  ...
  <div class="modal fade" id="view_details" style="display : none;">
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              echo anchor('partner/partner/edit_profile','<span style="font-size:14px;"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Profile</span> ' ); 
            ?></div></h4>
