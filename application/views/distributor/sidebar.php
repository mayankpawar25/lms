    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../UI/general.html"><i class="fa fa-circle-o"></i> Add Leads</a></li>
            <li><a href="<?php echo base_url('distributor/leads/all_leads'); ?>"><i class="fa fa-circle-o"></i> Show Leads</a></li>
