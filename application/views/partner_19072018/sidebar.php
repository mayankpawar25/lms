      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('partner/lead/add_lead'); ?>"><i class="fa fa-plus"></i> Add Lead</a></li>
            <li><a href="<?php echo base_url('partner/lead/all_leads'); ?>"><i class="fa fa-circle-o"></i> View Leads</a></li>
           <li><a href="<?php echo base_url('partner/lead/assigned_leads'); ?>"><i class="fa fa-circle-o"></i> Assigned Leads</a></li>
