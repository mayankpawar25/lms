...
<div class="login-box-body">
    ...
    <form action="<?php echo current_url();?>" method="post" id="login-form">
        <div class="form-group has-feedback">
            <input type="email" name="userpassword" class="form-control" placeholder="UserPassword">
   ...
   <!--  <a href="<?php echo base_url();?>distributor/auth/ForgotPassword">I forgot my password</a><br>
