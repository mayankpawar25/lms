                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="button" class="btn btn-primary  " id="submit" name="change_password" value="Save" style="border-radius:0; min-width:200px;"/>
                            </div>
                        </div>
                       <!--  <div class="col-sm-6 col-md-4">
...
<?php } ?>
   <div class="clearfix"></div>
        <div class="form-group text-center">
            ...
            <input type="submit" class="btn btn-primary btn-block " name="profile" value="Save" style="border-radius:0;"/>
        </div>
