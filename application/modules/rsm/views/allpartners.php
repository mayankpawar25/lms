                    ...
                    foreach ($satat as $partner){
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                               <?php echo ($partner['approval']) ? '<a href="javascript:void(0)" data-id="'.$partner['id'].'" class="approved-partn "><span class="active-btn btn-success btn-xs">Approved</span></a>' : '<a href="javascript:void(0)" data-id="'.$partner['id'].'" class="disapprove-partn  "><span class="inactive-btn btn-danger btn-xs">Disapproved</span></a>' ?>
                            </td>
                            <td>
                                <span class= "btn btn-info btn-xs" data-toggle="modal" data-target="#view" onclick="view(<?php echo $partner['id']; ?>)"  title="View Partners Details"><i class="fa fa-eye"></i></span>
