...
?>
 <div class="login-box-heading"><h2><span class="glyphicon glyphicon-user " ></span> <span class="seprate-line">|</span> RSM Login</h2></div> 
...
<p class="text-center">
    ...
    <a href="<?php echo site_url('rsm/auth/forget_password') ?>">I forgot my password</a><br>
