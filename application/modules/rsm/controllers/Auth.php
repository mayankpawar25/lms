...
class Auth extends MY_Controller {
    function __construct(){
        ...
        //$this->output->set_title('RSM Login');
        $this->load->model('rsm');
        ...
        if ($this->input->method(TRUE) === 'POST'){
            if ($this->authmodel->verify_validation()){
                ...
                if ($this->authmodel->check_login($username,$password)){
                    $user_data = $this->rsm->get_admin($username);
    ...
    /*Function for RSM  Forget password*/
    public function forget_password(){
        ...
        if($this->input->post('email')){
            ...
            if($token){
             ...
             $message = '<p>Hello </p><br> <br><p>Please <a href="'.base_url('rsm/auth/reset_password/'.$token).'">click here</a> to reset your password </p> <br><br> <p></p>';
                ...
                if($mail_res)
                {
                    ...
                    redirect('rsm/auth/forget_password');         
                }
            }else{
        ...
        if($token){
            ...
            if($this->input->post()){
                ...
                if($this->form_validation->run()){
                    ...
                    redirect(base_url('rsm/auth/reset_password'));
                }
            }
