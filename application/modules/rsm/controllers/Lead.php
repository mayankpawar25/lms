...
class Lead extends MY_Controller {
    function __construct(){
        ...
        $ajax_view = ['show_partners_dropdown','view_partner_details'];
    ...
    $this->breadcrumbs->push('Manage Users ', 'rsm/');
    $this->breadcrumbs->push('All Leads ', 'section/page/page');
   ...
   /* public function add_lead(){
    ...
    public function view_partner_details(){
        $this->load->model('leads');        
        $id = $this->input->post('id');
        $data = $this->leads->get_partner_details($id);
        $dt['data'] = (array)$data;
