        ...
        <div class="box-body">
            ...
            <table id="example4" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $lead['followup_status']; ?></td>
                            <td>
                            <?php 
                                if($lead['approval']==1){
                ...
                ?> -->
                            ...
                            <td>
                                <?php 
                                // echo anchor('admin/lead/edit_lead/'.base64_encode($lead['id']), '<span class= "btn btn-xs btn-info" title="Edit Leads"><i class="fa fa-pencil"></i></span> ' ); 
                                ?>
                                ...
                                ?>
                                        ...
                                        <span title="Show History" class= "btn btn-info btn-xs" data-toggle="modal" data-target="#lead-history" onclick="view_assigned(<?php echo $lead['id']; ?>,'history')"><i class="fa fa-history"></i></span>
...
$(document).on('click','.active-lang',function(){
    ...
    var id = $(this).attr('st-data-id');
        ...
        if(isConfirm == true){
          swal({
            title: 'Success!',
            text: 'Lead Inactive Successfully..!',
            type: 'success'
          }, function(isConf){
                //location.reload();
              if (!isConf) return;
...
#example4 tr>th:last-child, #example4 tr>td:last-child, #example4 tr>th:nth-last-child(2), #example4 tr>td:nth-last-child(2){width:35px!important; min-width:35px!important; }

	 #example4 tr>th:nth-last-child(1), #example4 tr>td:nth-last-child(1){text-align:center;}
</style>
