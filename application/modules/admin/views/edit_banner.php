                ...
                <input type="file" name="profile_pic"  class="form-control" id="avatar" style="width:30%" />
                   ...
                   <div class="">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <textarea class="form-control" rows = "5" cols = "50" name="banner_content"><?php echo $banner['banner_text']; ?></textarea>
                   ...
                   <div class="row">
                    <div class="col-sm-6 col-md-4">
                        ...
                        <input type="submit" class="btn btn-primary btn-block " name="up_image" value="Update" style="border-radius:0;width:42%"/>
                        </div>
                        </div>
