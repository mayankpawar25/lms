                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class= "btn btn-success btn-xs" data-toggle="modal" data-target="#view" onclick="view(<?php echo $lead['id']; ?>)"  title="View Partner Details"><i class="fa fa-eye"></i></span>
...
function view(id) {
    //alert(id);
            $.ajax({
                type: "POST",
                url: '<?php echo site_url('admin/lead/view_deleted_lead_details');?>',
                // async: false,
                data: {'id': id},
...
function restore(id){
    ...
    swal({
        ...
        if(isConfirm == true){
          swal({
            title: 'Success!',
            text: 'Your Lead Restored Successfully..!',
            type: 'success'
          }, function(isConf){
              if (!isConf) return;
              $.ajax({
...
<style>
#example7 tr>th:nth-child(15){min-width:100px;}



#example7 tr>th:last-child, #example7 tr>td:last-child{width:35px!important; min-width:35px!important; }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">Deleted Lead Details</h4>
                </div>
                <div class="modal-body">
                    <div class="box-body pad">
