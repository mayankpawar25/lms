                     ...
                     foreach ($leads as $lead){
                        ...
                        <tr>
                           ...
                           <!--  <td><?php echo $leads['street']; ?></td> -->
                            ...
                            <td><?php echo anchor('/partner/edit_subdistributor/'.$leads['id'], '<span class= "btn btn-info">Edit</span> ' ); ?> 
...
function delete_leads(id){
    ...
    if (result) {
        $.ajax({
            type:'POST',
            url:'<?php echo site_url('partner/leads/delete_leads');?>',
            data:{'id':id},
...
$(document).on('click','.inactive-lang, .inactive-lang.label.label-default',function(){
    ...
    if(result){      
        ...
        var status_check = 1;
        var eve = $(this);
        $.post('<?php echo site_url('partner/leads/update_status');?>',
