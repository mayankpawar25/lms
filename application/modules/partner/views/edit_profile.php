  ...
  <div class="tab-content">
      ...
      <form method="post" action="<?php echo current_url();?>" enctype="multipart/form-data">
        ...
        <br />
        	...
        	<ul class="list-inline">
            	<li>
                	 <input type="file" name="profile_pic"  class="form-control hidden" id="avatar" accept="image/gif, image/jpeg , image/jpg , image/png"  required/>
    ...
    <br />
      <h4>Change your Password</h4>
            ...
            <form method="post" action="<?php echo base_url();?>partner/partner/changepassword" id="passwordform" enctype="multipart/form-data">
    ...
    <!--  -->
                         ...
                         <br />
              <h4>Edit</h4>
              <!-- <small style="color: red"><b>Note: You can edit only Firm Name And Owner Name.</b></small> -->
              <form method="post" action="<?php echo current_url();?>" enctype="multipart/form-data">
                <?php 
...
*/
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
              <th>Firm Name</th>
              <td>
                <input type="text" name="firm_name" value="<?php echo $detail['firm_name']; ?>" class="form-control" required>
            </td>
            </tr>
            ...
            <tr>
              <th>Owner Name</th>
              <td>
                <input type="text" name="owner_name" value="<?php echo $detail['owner_name']; ?>" class="form-control" required>
             ...
             <tr>
              <th>Contact No</th>
              <td><input type="text" name="contact_no" value="<?php echo $detail['contact_no']; ?>" class="form-control" disabled></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="text" name="firm_incorporation_date" class="form-control" value="<?php echo date( "d-m-Y", strtotime ( $detail['firm_incorporation_date'] ) ); ?>" disabled></td>
            </tr>
...
$(document).on('click','#submit', function(){
              //var site_url_profile = "<?php site_url('partner/partner/edit_profile'); ?>";
                  ...
                  $.ajax({
                        ...
                        success: function(response) {
                               if(response == 'wrongpassword'){
                                  ...
                                  $('.box').load('<?php echo site_url(); ?>partner/edit_profile .box');
                                  console.clear();
                               }else{
