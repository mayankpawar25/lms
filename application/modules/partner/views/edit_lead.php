...
<div class="container">
            ...
            <?php echo form_error('customer_segment'); ?>
                ...
                <?php } ?>
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        ?>
                        <option <?php if($value['ms_bdm']==$bdm['id']){ ?> selected="selected" <?php }?> value="<?php echo $bdm['id']; ?>"><?php echo $bdm['bdm_name']; ?></option>
                        <?php
                            }
                        }
                        ?>
            ...
            <?php echo form_error('ms_bdm'); ?>
                    ...
                    <?php if($value['total_deal_value']!=''){ ?>

                    <div class="col-sm-6 col-md-4 live" >
                        <div class="form-group">
                        <label>Total Deale Value*</label>
