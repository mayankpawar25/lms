             ...
             <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                   <!--  <a href="<?php echo site_url('studentfee') ?>"> -->
                        <div class="icon material-icons"><i class="fa fa-users"></i></div>
                        <div class="content">
                            ...
                            <div class="number count-to ">
                             ...
                             <div class="text"><b><a href="<?php echo base_url()?>rsm/partner/all_partners">Total Partners</a></b></div>
                        </div>
                  <!--   </a> -->
                </div> 
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    <!-- <a href="<?php echo site_url('admin/expense') ?>"> -->
                        <div class="icon material-icons"><i class="fa fa-thumbs-up"></i></div>
                        <div class="content">
                            ...
                            <div class="number count-to">
                              ...
                              <div class="text"><b><a href="<?php echo base_url()?>rsm/partner/all_partners">Approved Partners</a></b></div>
                        </div>
                   <!--  </a> -->
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                   <!--  <a href="<?php echo site_url('student/search') ?>"> -->
                        <div class="icon material-icons"><i class="fa fa-ban"></i></div>
                        <div class="content">
                            ...
                            <div class="number count-to">
                              ...
                              echo count($state);
                              ?>
                              <?php //echo $total_inactive_partners['total']; ?></div>
                              <div class="text"><b><a href="<?php echo base_url()?>rsm/partner/all_partners">Inactive Partners</a></b></div>
                        </div>
                   <!--  </a> -->
                </div>
            </div>
              ...
              ?>
                    <div class="item <?php if($count ==1){ echo"active";}  ?>">
                      ...
                      <div class="carousel-caption">
                          <div class="row">
                              <div class="col-sm-8">
                                  <h2 style="margin-top:0px; text-align: left;"><?php echo $banner['banner_text']; ?></h2>
                              </div>
                              <div class="col-sm-4 pull-right">
                                <p><a href="<?php echo $banner['button_link']; ?>" target="_blank" class="btn btn-primary slider-btn btn-lg waves-effect "><?php echo $banner['button_text']; ?></a></p>
                              </div>
                            </div>
                          </div>
                      </div>
